...
**Compression:** Days 5–6 merge (CI morning, GitOps afternoon). Days 7–8 merge (headers + ClamAV morning, scanners + capstone afternoon). See [`instructor/schedule-5-day-compress.md`](../instructor/schedule-5-day-compress.md).
